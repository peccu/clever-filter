...
describe('Article API:', function() {
  ...
  describe('PUT /api/articles/:id', function() {
    ...
    it('should respond with the original article', function() {
      updatedArticle.name.should.equal('New Article');
      updatedArticle.info.should.equal('This is the brand new article!!!');
    });
